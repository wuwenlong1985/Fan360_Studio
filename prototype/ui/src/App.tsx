  ...
  return (
    <Layout className="app-shell">
      <Header className="topbar">
        ...
        <Space size={10}>
          <Badge status={connected ? "success" : "processing"} text={<span className="status-text">{connected ? "TCP 设备已连接" : "TCP 设备待连接"}</span>} />
          <Tooltip title="保存项目">
                ...
                children: (
                  <div className="device-panel">
                    <div className="device-status">
                      ...
                      <div>
                        <b>TCP 风扇设备</b>
                        <div className="muted">{connected ? `${deviceIp}:5000 · 已连接` : '等待手动连接'}</div>
                      </div>
